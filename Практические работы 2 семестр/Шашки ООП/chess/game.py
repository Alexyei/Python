...
class Game:
    ...
    def showRules():
        os.system("cls")
        print("Шашки (чекерс)".center(shutil.get_terminal_size().columns))
        print()
        ...
        print(
            ...
            'Шашка ходит и бьёт только вперёд на одну клетку.\n' +
            'Дамка ходит и бьёт в любом направлении на одну клетку.\n' +
            'Бить обязательно.\n' +
            'Побеждает тот, кто взял все шашки противника, или заблокировал их.')
        print()
